...
from schemas import Product, ProductCreate, ProductUpdate, ProductListResponse
...
def get_all_products(
    ...
    return service.get_all(skip, limit, min_price, max_price, search_filter, sort_by, order)
